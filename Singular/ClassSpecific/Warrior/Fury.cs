...
namespace Singular.ClassSpecific.Warrior
{
    public class Fury
    {
        ...
        #region Common
        [Behavior(BehaviorType.Pull, WoWClass.Warrior, WoWSpec.WarriorFury, WoWContext.All)]
        ...
        [Behavior(BehaviorType.PreCombatBuffs, WoWClass.Warrior, WoWSpec.WarriorFury, WoWContext.All)]
        public static Composite CreateFuryNormalPreCombatBuffs()
        {
            return new PrioritySelector();
        }

        [Behavior(BehaviorType.CombatBuffs, WoWClass.Warrior, WoWSpec.WarriorFury, WoWContext.All)]
        public static Composite CreateFuryNormalCombatBuffs()
        {
            return new PrioritySelector(
                ...
                Spell.Cast("Deadly Calm"));
        }

        [Behavior(BehaviorType.Combat, WoWClass.Warrior, WoWSpec.WarriorFury, WoWContext.All)]
