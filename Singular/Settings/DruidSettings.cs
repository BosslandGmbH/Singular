...
*/
        ...
        [Description("Toggle when the artifact weapon ability should be used. NOTE: Guardian Specialization artifact is only affected by the 'None' setting.")]
        public UseDPSArtifactWeaponWhen UseDPSArtifactWeaponWhen { get; set; }

        [Setting]
        [DefaultValue(50)]
        [Category("Artifact Weapon Usage")]
        [DisplayName("Guardian: Health Percent to Use")]
        ...
        [Description("If set to true, this will make the artifact waepon only be used when more than one mob is attacking us. NOTE: Guardian Specialization artifact is not affected by this.")]
