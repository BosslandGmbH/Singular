    ...
    public class Protection
    {
            ...
            return new PrioritySelector(
                ...
                new Decorator(
                    ...
                    new PrioritySelector(
                        ...
                        Spell.Cast(
                            "Shoot", ret => StyxWoW.Me.CurrentTarget.IsFlying &&
        ...
        public static Composite CreateProtectionNormalCombatBuffs()
        {
            return new PrioritySelector(
                ...
                new Decorator(
                    ret => StyxWoW.Me.HealthPercent <= SingularSettings.Instance.Warrior.WarriorEnragedRegenerationHealth,
                    new PrioritySelector(
                ...
                //Offensive Cooldowns
                Spell.Buff("Retaliation", ret => Clusters.GetClusterCount(StyxWoW.Me, Unit.NearbyUnitsInCombatWithMe.Where(u => u.PowerType != WoWPowerType.Mana), ClusterType.Cone, 6f) >= 3),
                Spell.BuffSelf("Deadly Calm", ret => StyxWoW.Me.RagePercent < 10 && Clusters.GetClusterCount(StyxWoW.Me, Unit.NearbyUnitsInCombatWithMe, ClusterType.Radius, 10f) >= 3),
                Spell.BuffSelf(
                    "Inner Rage", ret => StyxWoW.Me.RagePercent > 90 && ((SpellManager.HasSpell("Deadly Calm") && SpellManager.Spells["Deadly Calm"].Cooldown) || !SpellManager.HasSpell("Deadly Calm"))),
                // Fear Remover
            ...
            return new PrioritySelector(
                ...
                new Decorator(
                    ...
                    new PrioritySelector(
                        ...
                        Spell.Cast(
                            "Disarm", ctx => StyxWoW.Me.CurrentTarget.DistanceSqr < 36 &&
