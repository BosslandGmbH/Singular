    ...
    public class Protection
    {
        ...
        public static Composite CreateProtectionNormalCombatBuffs()
        {
            return new PrioritySelector(
                ...
                Spell.BuffSelf("Inner Rage", ret => StyxWoW.Me.RagePercent > 90 && ((SpellManager.HasSpell("Deadly Calm") && SpellManager.Spells["Deadly Calm"].Cooldown) || !SpellManager.HasSpell("Deadly Calm"))),                // Fear Remover
