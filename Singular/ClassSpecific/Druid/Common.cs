...
namespace Singular.ClassSpecific.Druid
{
    public class Common
    {
        ...
        private static WoWUnit _moveToHealUnit;
        ...
        public static Composite CreateDpsDruidOffHealBehavior()
        {
            ...
            int cancelHeal =
                Math.Max(SingularSettings.Instance.IgnoreHealTargetsAboveHealth, DruidSettings.OffHealSettings.HealingTouch);
            ...
            if (CompositeBuilder.CurrentBehaviorType == BehaviorType.Heal)
        ...
        public static Composite CreateNonRestoRest()
        {
            return new PrioritySelector(
                // If we have restoration affinity, we could probably change this to cast Healing Touch instead.
                Rest.CreateDefaultRestBehaviour("Regrowth", "Revive"),
        ...
        internal static Composite CreateProwlBehavior(SimpleBooleanDelegate requirements = null)
        {
            ...
            BehaviorType createdByBehavior = CompositeBuilder.CurrentBehaviorType;
            ...
            string createdBy = createdByBehavior + " " + CompositeBuilder.CurrentBehaviorName;
            return new Sequence(
                ctx => needProwl(ctx),
            ...
            return new Throttle(5,
                new Decorator(
                    req => !Spell.IsCastingOrChannelling() && !Spell.IsGlobalCooldown()
                           ...
                           && !Me.InVehicle
                           && !Me.IsOnTransport
                           && !EventHandlers.IsShapeshiftSuppressed
                           && BotPoi.Current != null
                    ...
                    new Sequence(
                        new PrioritySelector(
                            new Decorator(
                                ...
                                new Sequence(
                                    new PrioritySelector(
                                        CastForm(ShapeshiftForm.Travel,
                                            req =>
                                            {
            ...
            return new Decorator(
                ...
                new ThrottlePasses(
                    ...
                    new Sequence(
                        ...
                        new SeqLog(1, LogColor.Hilite, s => "^Rooted: attempting root-break shapeshift"),
                        new PrioritySelector(
