    ...
    public static class Rest
    {
        ...
        public static Composite CreateDefaultRestBehaviour()
        {
            return new PrioritySelector(
                ...
                new Decorator(
                    ret => (StyxWoW.Me.HealthPercent <= SingularSettings.Instance.MinHealth || (StyxWoW.Me.PowerType == WoWPowerType.Mana && StyxWoW.Me.ManaPercent <= SingularSettings.Instance.MinMana)) &&
                ...
                new Decorator(
                    ...
                    new ActionAlwaysSucceed()),
                new Decorator(
                    ret => (StyxWoW.Me.PowerType == WoWPowerType.Mana && StyxWoW.Me.ManaPercent <= SingularSettings.Instance.MinMana) || StyxWoW.Me.HealthPercent <= SingularSettings.Instance.MinHealth,
