...
namespace Singular
{
    ...
    {
        /// <summary>Creates the ensure movement stopped behavior. Will return RunStatus.Success if it has stopped any movement, RunStatus.Failure otherwise.</summary>
        /// <remarks>Created 5/1/2011.</remarks>
        /// <returns>.</returns>
        ...
        /// <summary>Creates a behavior that does nothing more than check if we're facing the target; and if not, faces the target. (Uses a hard-coded 70degree frontal cone)</summary>
        /// <remarks>Created 5/1/2011.</remarks>
        /// <returns>.</returns>
        ...
        /// <summary>Creates a move to target behavior. Will return RunStatus.Success if it has reached the location, or stopped in range. Best used at the end of a rotation.</summary>
        /// <remarks>Created 5/1/2011.</remarks>
        ...
        /// <summary>Creates a move behind target behavior. Will return RunStatus.Success if it has reached the location, or stopped in range. Best used at the end of a rotation.</summary>
        /// <remarks>Created 5/1/2011.</remarks>
        ...
        /// <summary>Creates a move to location behavior. Will return RunStatus.Success if it has reached the location, or stopped in range. Best used at the end of a rotation.</summary>
        /// <remarks>Created 5/1/2011.</remarks>
