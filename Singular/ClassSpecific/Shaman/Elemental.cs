    ...
    partial class SingularRoutine
    {
        ...
        public Composite CreateElementalShamanCombat()
        {
            return new PrioritySelector(
                ...
                CreateSpellBuff("Flame Shock", ret => !HasMyAura("Flame Shock", Me.CurrentTarget, TimeSpan.FromSeconds(2), 1)),         
                ...
                CreateSpellCast("Earth Shock", ret => 
                    (HasAuraStacks("Lightning Shield", 6) || !HaveTalentFulmination) && HasMyAura("Flame Shock", Me.CurrentTarget, TimeSpan.FromSeconds(5), 1)),
